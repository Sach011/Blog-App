  ...
  return (
    <div className="bg-blue-100">
      <div className="container mx-auto my-12 p-4 space-y-9">
        ...
        <p>
          This is <strong>Sachin Vishwakarma</strong> a proficient full stack
          ...
          user-friendly web application, Sachin excels in crafting seamless
          digital experiences.
        </p>
        ...
        <br />
        <span>
          Sachin Vishwakarma is dedicated to leveraging his expertise to
          contribute to innovative projects and drive technological
          advancements. Whether working on front-end interfaces or back-end
          logic, he is passionate about delivering exceptional digital solutions
          that meet user needs and exceed client expectations.
        </span>
        <h2 className="font-semibold text-blue-800 text-xl">
          Personal Interests and Inspiration:
        </h2>
        <p>
          Beyond his professional achievements, Sachin is a big fan of cricket
          ...
          significantly shaped Sachin’s journey. Ankush is not only a great
          competitor but also a steadfast friend, constantly motivating Sachin
